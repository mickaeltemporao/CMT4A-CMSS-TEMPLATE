...
```{r, eval=TRUE, echo=FALSE, cache=FALSE, size="small", fig.cap="A Figure That Needs a Better Title", out.width="75%", fig.align="center", message=F, warning=F}
library(anesr)
...
```{r, eval=TRUE, echo=FALSE, cache=FALSE, size="small", fig.cap="Another Figure That Should Get a Better Title", out.width="75%", fig.align="center", message=F, warning=F}
...
```{r, echo=FALSE, eval=TRUE, tidy = TRUE, size="small", cache=FALSE, results="asis", out.width="75%", fig.align="center", message=F, warning=F}
...
```{r, eval=TRUE, echo=FALSE, cache=FALSE, size="small", fig.cap="What's wrong with this figure?", message=F, warning=F}
...
ggplot(plot_df, aes(x=predicted_prob, y=trump_int)) +
  geom_jitter(width=0.025, height=.2, shape=1) +
  geom_smooth(method="glm", method.args=list(family="binomial"), fullrange=TRUE, color="red") +
