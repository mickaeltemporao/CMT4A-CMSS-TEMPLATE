...
- Find the key of your article in your `refernces.bib` file (e.g. downs1957economic).
- Put an @ before the key (e.g. @downs1957economic)
- Use @downs1957economic for author's name part of the narrative (e.g. Downs (1957) found that ...)
- Use [@downs1957economic] for author's name in parentheses (eg. Ideological positions summarize ... (Downs, 1957))
```
